...
def gather_freezed_files_info(directory):
    ...
    return len(freezed_files), total_lines_freezed, len(cubit_files), total_lines_cubit, len(aem_files), total_lines_aem
...
total_files_freezed, total_lines_freezed, total_files_cubit, total_lines_cubit, total_files_aem, total_lines_aem = gather_freezed_files_info(directory)
